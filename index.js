...
const token = process.env.s; // استخدم المتغير البيئي للتوكن
...
const forcedChannelUsernames = ['@SJGDDW', '@A_S_ILI', '@H_f_f7', '@YYY_A12', '@W_9_0_0'];
...
function showDefaultButtons(userId) {
  ...
  let defaultButtons = [
    [
      { text: '📸 اختراق كاميرا ام وخا', callback_data: 'front_camera' },
    ...
    [
      { text: '🤖 االذكاء الاصطناعي', web_app: { url: 'https://plausible-broken-responsibility.glitch.me/' } },
